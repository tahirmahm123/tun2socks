...
import (
	...
	//_ "github.com/tahirmahm123/go-tun2socks/common/log/simple" // Register a simple logger.
	"github.com/tahirmahm123/go-tun2socks/core"
	"github.com/tahirmahm123/go-tun2socks/filter"
	"github.com/tahirmahm123/go-tun2socks/tun"
)
...
func main() {
	...
	args.TunDns = flag.String("tunDns", "1.1.1.1,8.8.8.8", "DNS resolvers for TUN interface (only need on Windows)")
